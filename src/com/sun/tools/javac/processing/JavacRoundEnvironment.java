...
/**
 * Object providing state about a prior round of annotationProcesser processing.
 *
...
public class JavacRoundEnvironment implements RoundEnvironment {
    ...
    private static final String NOT_AN_ANNOTATION_TYPE =
        "The argument does not represent an annotationProcesser type: ";

    /**
     * Returns the elements annotated with the given annotationProcesser type.
     * Only type elements <i>included</i> in this round of annotationProcesser
     ...
     *
     * @param a  annotationProcesser type being requested
     * @return the elements annotated with the given annotationProcesser type,
