...
public class JavacMessager implements Messager {
     ...
     * annotationProcesser mirror of the annotated element.
     *
     * @param kind the kind of message
     * @param msg  the message, or an empty string if none
     * @param e    the annotated element
     * @param a    the annotationProcesser to use as a position hint
     */
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
    ...
    /**
     * Prints a message of the specified kind at the location of the
     * annotationProcesser value inside the annotationProcesser mirror of the annotated
     * element.
     *
     * @param kind the kind of message
     * @param msg  the message, or an empty string if none
     * @param e    the annotated element
     * @param a    the annotationProcesser containing the annotaiton value
     * @param v    the annotationProcesser value to use as a position hint
     */
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
