 ...
 * annotationProcesser processing.
 *
...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
    ...
    private Set<String> initPlatformAnnotations() {
        ...
        platformAnnotations.add("java.lang.annotationProcesser.Documented");
        platformAnnotations.add("java.lang.annotationProcesser.Inherited");
        platformAnnotations.add("java.lang.annotationProcesser.Retention");
        platformAnnotations.add("java.lang.annotationProcesser.Target");
     ...
     * caches the supported annotationProcesser information from the first (and
     ...
     * annotationProcesser processing.  The iterator first visits already
    ...
    /**
     * Helper object for a single round of annotationProcesser processing.
     */
    class Round {
        /** The round number. */
        final int number;
        ...
        void findAnnotationsPresent() {
            ...
            // Use annotationProcesser processing to compute the set of annotations present
    ...
    // TODO: internal catch clauses?; catch and rethrow an annotationProcesser
    // processing error
    public JavaCompiler doProcessing(Context context,
        ...
        /*
         * If an annotationProcesser processor raises an error in a round,
    ...
    /**
     * Free resources related to annotationProcesser processing.
     */
    public void close() {
        filer.close();
     ...
     * {@inheritdoc}
     *
     * Command line options suitable for presenting to annotationProcesser
     * processors.
