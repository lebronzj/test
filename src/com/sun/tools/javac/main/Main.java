...
public class Main {
                          ...
                          Iterable<? extends Processor> processors)
    {
         ...
         * should be updated to take annotationProcesser processing semantics
         * into account.
         */
        try {
            if (args.length == 0
     ...
     * annotationProcesser processor.
     */
    void apMessage(AnnotationProcessingError ex) {
        log.printLines(PrefixKind.JAVAC, "msg.proc.annotationProcesser.uncaught.exception");
        ex.getCause().printStackTrace(log.getWriter(WriterKind.NOTICE));
    }
