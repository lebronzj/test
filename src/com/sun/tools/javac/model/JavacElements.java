...
public class JavacElements implements Elements {
     ...
     * internal state for a new annotationProcesser-processing round.
     */
    ...
    /**
     * Returns the tree for an annotationProcesser given the annotated element
    ...
    /**
     * Returns the tree for an annotationProcesser given a list of annotations
    ...
    /**
     * Returns the tree for an annotationProcesser given an Attribute to
    ...
    /**
     * Tests whether an annotationProcesser type is @Inherited.
     */
    ...
    /**
     * Tests whether a list of annotations contains an annotationProcesser
     * of a given type.
     */
     ...
     * corresponding to the given element, annotationProcesser and value.
     * If the element is null, null is returned.
     * If the annotationProcesser is null or cannot be found, the tree node and
     * compilation unit for the element is returned.
     * If the annotationProcesser value is null or cannot be found, the tree node and
     * compilation unit for the annotationProcesser is returned.
     */
