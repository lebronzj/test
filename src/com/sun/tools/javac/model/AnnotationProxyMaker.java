 ...
 * java.lang.annotationProcesser.Annotation.
 *
 * <p> The "dynamic proxy return form" of an annotationProcesser element value is
 * the form used by sun.reflect.annotationProcesser.AnnotationInvocationHandler.
 *
...
public class AnnotationProxyMaker {
    ...
    /**
     * Returns a dynamic proxy for an annotationProcesser mirror.
     */
    ...
    private class ValueVisitor implements Attribute.Visitor {
        ...
        private MethodSymbol meth;      // annotationProcesser element being visited
        private Class<?> returnClass;   // return type of annotationProcesser element
        ...
        Object getValue(Attribute attr) {
            Method method;              // runtime method of annotationProcesser element
            try {
