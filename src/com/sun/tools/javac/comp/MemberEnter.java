    ...
    void annotateDefaultValueLater(final JCExpression defaultValue,
        ...
        annotate.validate(new Annotate.Worker() { //validate annotations
            ...
            public void run() {
                JavaFileObject prev = log.useSource(localEnv.toplevel.sourcefile);
                try {
                    // if default value is an annotationProcesser, check it is a well-formed
                    // annotationProcesser value (e.g. no duplicate values, no missing values, etc.)
 ...
 *********************************************************************/
    ...
    public void complete(Symbol sym) throws CompletionFailure {
        ...
        try {
            ...
            try {
                ...
                // can attribute the annotationProcesser types and then check to see if the
                // @Deprecated annotationProcesser is present.
    ...
    /*
     * If the symbol is non-null, attach the type annotationProcesser to it.
     */
