...
public class TypeAnnotations {
    ...
    /**
     * Determine whether an annotationProcesser is a declaration annotationProcesser,
     * a type annotationProcesser, or both.
     */
    ...
    /** Infer the target annotationProcesser kind, if none is give.
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        private void separateAnnotationsKinds(JCTree typetree, Type type, Symbol sym,
            ...
            if (type == null) {
                ...
                // typeWithAnnotations side-effects the type annotationProcesser positions.
        ...
        // We found a type annotationProcesser in a declaration annotationProcesser position,
        // for example, on the return type.
        // Such an annotationProcesser is _not_ part of an JCAnnotatedType tree and we therefore
        // need to set its position explicitly.
        // The method returns a copy of type that contains these annotations.
        //
        // As a side effect the method sets the type annotationProcesser position of "annotations".
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                while (enclEl != null &&
                    ...
                    // completely resolved and we cannot distinguish where the annotationProcesser
                ...
                if (enclTy != null &&
                    ...
                    case 0:
                        ...
                        // The normal declaration annotationProcesser checks make sure that the use is valid.
                        break;
                    case 1:
                ...
                // The genericLocation for the annotationProcesser.
                ListBuffer<TypePathEntry> depth = new ListBuffer<>();
                ...
                if (depth.nonEmpty()) {
                    // Only need to change the annotationProcesser positions
         ...
         * type annotations: determine the type annotationProcesser positions.
         */
                ...
                case VARIABLE:
                    ...
                    switch (v.getKind()) {
                        ...
                        case RESOURCE_VARIABLE:
                            ...
                            break;
                        default:
                            Assert.error("Found unexpected type annotationProcesser for variable: " + v + " with kind: " + v.getKind());
                    }
