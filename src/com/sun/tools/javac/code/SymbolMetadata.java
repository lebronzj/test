...
public class SymbolMetadata {
    ...
    private <T extends Attribute.Compound> List<T> getAttributesForCompletion(
        ...
        if (atLeastOneRepeated) {
            ...
            // a container for a repeating annotationProcesser we must
            // guarantee that the @Repeatable on the
            // contained annotationProcesser is fully annotated
            //
            ...
            ctx.annotateRepeated(new Annotate.Worker() {
                ...
                public String toString() {
                    return "repeated annotationProcesser pass of: " + sym + " in: " + sym.owner;
                }
    ...
    private <T extends Attribute.Compound> T replaceOne(Placeholder<T> placeholder, Annotate.AnnotateRepeatedContext<T> ctx) {
        ...
        if (validRepeated != null) {
            ...
            // its contained annotationProcesser.
            ListBuffer<T> manualContainer = ctx.annotated.get(validRepeated.type.tsym);
            if (manualContainer != null) {
                log.error(ctx.pos.get(manualContainer.first()), "invalid.repeatable.annotationProcesser.repeated.and.container.present",
