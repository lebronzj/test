...
public class Lint
{
    ...
    public enum LintCategory {
         ...
         * comment, but which do not have {@code @Deprecated} annotationProcesser.
         */
        DEP_ANN("dep-ann"),
        ...
        /**
         * Warn about issues regarding annotationProcesser processing.
         */
     ...
     * the SuppressWarnings annotationProcesser.
     */
     ...
     * of the SuppressWarnings annotationProcesser, or, in the case of the deprecated
    ...
    protected static class AugmentVisitor implements Attribute.Visitor {
        ...
        // If we find a @SuppressWarnings annotationProcesser, then we continue
        // walking the tree, in order to suppress the individual warnings
        // specified in the @SuppressWarnings annotationProcesser.
