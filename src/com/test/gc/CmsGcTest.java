 ...
 * -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=95 -XX:-UseCMSInitiatingOccupancyOnly
 * 计算出来各个区占用空间情况是：
...
public class CmsGcTest {
    ...
    static final int M_112_INT_SIZE = (int) (28 * 1024 * 1024);   //112M = 4byte * 28M
