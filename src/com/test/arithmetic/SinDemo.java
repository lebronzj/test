...
public class SinDemo extends JFrame{
    ...
    public void paint (Graphics g) {
        ...
        g.drawString("1y = " + df.format(cx) + " * sin( " + df.format(cy) + " * x)", 50, 50);
    ...
    public static void main (String args[]) {
        System.out.println(Math.sin(60*Math.PI/180)*Math.sin(60*Math.PI/180)+Math.sin(30*Math.PI/180)*Math.sin(30*Math.PI/180));
