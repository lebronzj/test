...
public class NioSocketServer extends Thread {
    ...
    public void initServer() throws IOException {
        ...
        System.out.println("dssdsd:"+serverSocketChannel.socket().getReceiveBufferSize());
    ...
    public void read(SelectionKey selectionKey) {
        ...
        try {
            ...
            ByteBuffer byteBuffer = ByteBuffer.allocate(1200000000);
            int len = 0;
            ...
            System.out.println("NioSocketServer receive from client:" + content.toString());
